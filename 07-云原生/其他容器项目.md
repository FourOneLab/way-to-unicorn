...
![容器架构](/images/container-arch.png)
...
![Kata Container](/images/kata-container.png)
...
![Kata Containers 实现原理](/images/kata-container-imp.png)
...
![gVisor的Sentry进程有两种不同的实现方式](/images/system-call.png)
