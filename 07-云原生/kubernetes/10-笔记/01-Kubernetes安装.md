---
title: 01 Kubernetes安装
date: 2020-04-14T10:09:14.206627+08:00
draft: false
---

- [0.1. 配置防火墙](#01-配置防火墙)
- [0.2. 配置Selinux](#02-配置selinux)
- [0.3. 安装Kubernetes集群](#03-安装kubernetes集群)
- [0.4. kubeadm安装集群](#04-kubeadm安装集群)
  - [0.4.1. 配置yum源](#041-配置yum源)
  - [0.4.2. 下载docker的yum源](#042-下载docker的yum源)
  - [0.4.3. 安装docker](#043-安装docker)
  - [0.4.4. 使用官方安装脚本自动安装](#044-使用官方安装脚本自动安装)
  - [0.4.5. 手动安装](#045-手动安装)
  - [0.4.6. 安装校验](#046-安装校验)
  - [0.4.7. 下载kubernetes的yum源](#047-下载kubernetes的yum源)
  - [0.4.8. 安装kubernetes](#048-安装kubernetes)
  - [0.4.9. 启动服务](#049-启动服务)
  - [0.4.10. 修改docker镜像地址](#0410-修改docker镜像地址)
- [0.5. 运行kubeadm init 安装Master](#05-运行kubeadm-init-安装master)
  - [0.5.1. 安装前的准备工作](#051-安装前的准备工作)
  - [0.5.2. 如果使用其他容器Runtime](#052-如果使用其他容器runtime)
  - [0.5.3. 查看配置文件](#053-查看配置文件)
- [0.6. 安装Harbor私有仓库](#06-安装harbor私有仓库)
  - [0.6.1. docker 配置私有源](#061-docker-配置私有源)
  - [0.6.2. 配置其他接待的hosts文件，使得访问私有源的地址都指向Harbor](#062-配置其他接待的hosts文件使得访问私有源的地址都指向harbor)
  - [0.6.3. harbor 启动私有镜像库](#063-harbor-启动私有镜像库)
    - [0.6.3.1. 安装Master](#0631-安装master)
  - [0.6.4. 部署容器网络插件](#064-部署容器网络插件)
  - [0.6.5. 通过 Taint/Toleration 调整 Master 执行 Pod 的策略](#065-通过-tainttoleration-调整-master-执行-pod-的策略)
    - [0.6.5.1. Pod 声明 Toleration](#0651-pod-声明-toleration)
  - [0.6.6. 部署Dashboard可视化插件](#066-部署dashboard可视化插件)
  - [0.6.7. 部署容器存储插件](#067-部署容器存储插件)
...
### 0.6.2. 配置其他接待的hosts文件，使得访问私有源的地址都指向Harbor
...
### 0.6.5. 通过 Taint/Toleration 调整 Master 执行 Pod 的策略
